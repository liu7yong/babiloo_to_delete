...
public class PtkDictMySqlReader extends BaseDictionaryReader {
    public PtkDictMySqlReader() {
        name = "ptkdict_mysql";
        title = "PtkDict (MySQL)";
    ...
    public IParser createParser( IInfo info, IMonitor monitor ) {
        return new PtkDictMySqlParser(
                info.getDataFileName(),
                info.getDataFileEncoding(),
                this, monitor );
    }

    public IConverter createConverter( IInfo info ) {
        return new PtkDictMySqlConverter( info );
    }
}
