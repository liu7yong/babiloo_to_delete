...
public class ActionBinderException extends Exception {
    public ActionBinderException( Config config, String message ) {
        super( buildExceptionMessage( config, message ) );
    }
    public ActionBinderException( Config config, Throwable cause ) {
        this( config, "", cause );
    }
    public ActionBinderException( Config config, String message, Throwable cause ) {
